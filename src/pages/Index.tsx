...
const Index = () => {
  ...
  const generateChart = async (birthDetails: BirthDetails) => {
    ...
    try {
      ...
      const [planetsResponse, navamshaResponse] = await Promise.all([
      ...
      const [planetsData, navamshaData] = await Promise.all([
        planetsResponse.json(),
        navamshaResponse.json()
      ]);
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-2">Vedic Astrology</h1>
